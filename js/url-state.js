...
const BIP39 = [
  'abides','ability','able','about','above','absent','absorb','abstract',
  ...
  'advice','aerobic','affable','afford','affright','again','age','agent',
  'agree','ahead','aim','air','airport','aisle','alarm','album',
  'alcove','alert','alien','all','alley','allow','almost','alone',
  'alpha','already','also','altar','always','amazing','ambient','among',
  'amount','amused','analyst','anchor','ancient','angel','angora','angular',
  ...
  'await','awake','aware','away','awesome','awhirl','awkward','axis',
  'baby','bachelor','bacon','badge','bag','balance','balcony','ball',
  'bamboo','banana','banner','bar','barely','bargain','barrel','base',
  'basic','basket','bathe','beach','bean','beauty','because','become',
  'bee','before','begin','behave','behind','believe','below','belt',
  'bench','benefit','best','betroth','better','between','beyond','bicycle',
  ...
  'cactus','cafe','cake','call','calm','camera','camp','can',
  'canary','cancel','candy','cannon','canoe','canvas','canyon','capable',
  ...
  'chimney','choice','choose','chrome','chuckle','chunk','churn','cigar',
  'cinnamon','circle','citizen','city','civil','claim','clap','clarify',
  'claude','clay','clean','clerk','clever','click','client','cliff',
  'climb','clinic','clip','clock','clog','close','cloth','cloud',
  'clown','club','clump','cluster','cmon','coach','coast','coconut',
  'code','coffee','coil','coin','collect','color','column','comb',
  'combine','comfort','comic','common','company','concert','conduct','confirm',
  'congrats','connect','consider','control','convince','cook','cool','copper',
  'copy','coral','core','corn','correct','cost','cotton','couch',
  'country','couple','course','cousin','covers','coyote','crack','cradle',
  'craft','cram','crane','crash','crater','crawl','crazy','cream',
  'credit','creek','crew','cricket','cried','crisp','critic','crop',
  'cross','crouch','crowd','crucial','cruft','cruise','crumble','crunch',
  ...
  'destiny','destroy','detail','detect','develop','device','devote','diagram',
  'dial','diamond','diary','dice','diesel','diet','differ','digital',
  'dignity','dilemma','dinner','dinosaur','direct','dirt','disagree','discover',
  'disease','dish','dismiss','disorder','display','distance','divert','divide',
  'division','dizzy','doctor','document','dog','doll','dolphin','domain',
  ...
  'energy','enforce','engage','engine','enhance','enjoy','eno','enough',
  'enrich','enroll','ensure','enter','entire','entry','envelope','episode',
  'equal','equip','era','erase','erode','erosion','error','erupt',
  'escape','essay','essence','estate','eternal','ethics','evidence','evince',
  'evoke','evolve','exact','example','excess','exchange','excite','exclude',
  'excuse','exemplar','exercise','exhaust','exhibit','exile','exist','exit',
  ...
  'foster','found','fox','fragile','frame','fred','fresh','friend',
  ...
  'gourmet','gown','grab','grace','grain','grant','grape','grass',
  ...
  'lawn','laws','layer','lazy','leader','leaf','learn','leave',
  ...
  'marine','market','marriage','mask','mass','massive','match','material',
  ...
  'must','mutual','my','mystery','myth','naive','name','napkin',
  ...
  'pear','peasant','pelican','pen','pencil','penguin','people','pepper',
  'perfect','permit','person','pet','phone','photo','phrase','physical',
  'piano','picnic','picture','piece','pig','pigeon','pill','pilot',
  'pink','pioneer','pipe','pistil','pitch','pizza','place','planet',
  'plastic','plate','play','please','pledge','pluck','plug','plunge',
  'poem','poet','point','polar','pole','polite','pond','pony',
  'pool','popular','portion','position','possible','post','potato','pottery',
  'poverty','powder','power','practice','praise','predict','prefer','prepare',
  'present','pretty','prevent','price','pride','primary','print','priority',
  'prism','private','prize','problem','process','produce','profit','program',
  ...
  'ribbon','rice','rich','ride','ridge','riff','right','rigid',
  'ring','riot','ripple','risk','ritual','rival','river','road',
  'roast','robot','robust','rocket','romance','roof','rookie','room',
  'rose','rotate','rough','round','route','royal','rubber','rude',
  'rug','rule','run','runway','rural','sad','saddle','sadness',
  'safety','sail','salad','salmon','salon','salt','salute','same',
  ...
  'slam','sleep','slender','slice','slide','slight','slim','slippy',
  ...
  'trouble','truck','true','truly','trumpet','trust','truth','trying',
